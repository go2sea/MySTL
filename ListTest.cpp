...
namespace MySTL {
	namespace ListTest {
		void testCase1(){
			std::cout << "ListTest testCase1 !!!" << std::endl;
			...
			*(std::begin(arr));
			...
			msL<int> l4(std::begin(arr), std::end(arr));
			...
			msL<int> l6(l2);
			l2.pop_back();
			assert(MySTL::Test::container_equal(l55, l66));
		...
		void testCase2(){
			std::cout << "ListTest testCase2 !!!" << std::endl;
			...
			msL<std::string> l2(std::begin(arr), std::end(arr));
			assert(!l2.empty());
			assert(l2.size() == 3);
		}
		void testCase3(){
			std::cout << "ListTest testCase3 !!!" << std::endl;

			std::string arr[] = { "1", "2", "3" };
			msL<std::string> l(std::begin(arr), std::end(arr));
			assert(l.back() == arr[2]);
		...
		void testCase4(){
			std::cout << "ListTest testCase4 !!!" << std::endl;
		...
		void testCase5(){
			std::cout << "ListTest testCase5 !!!" << std::endl;
		...
		void testCase6(){
			std::cout << "ListTest testCase6 !!!" << std::endl;
		...
		void testCase7(){
			std::cout << "ListTest testCase7 !!!" << std::endl;
		...
		void testCase8(){
			std::cout << "ListTest testCase8 !!!" << std::endl;
		...
		void testCase9(){
			std::cout << "ListTest testCase9 !!!" << std::endl;
		...
		void testCase10(){
			std::cout << "ListTest testCase10 !!!" << std::endl;

			int arr[] = { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
			stdL<int> l1(std::begin(arr), std::end(arr));
			msL<int> l2(std::begin(arr), std::end(arr));
		...
		void testCase11(){
			std::cout << "ListTest testCase11 !!!" << std::endl;

			int arr1[] = { 0, 1, 3, 5, 9 }, arr2[] = { 2, 4, 6, 7, 8 };
			stdL<double> first1(std::begin(arr1), std::end(arr1)), second1(std::begin(arr2), std::end(arr2));
			msL<double> first2(std::begin(arr1), std::end(arr1)), second2(std::begin(arr2), std::end(arr2));
		...
		void testCase12(){
			std::cout << "ListTest testCase12 !!!" << std::endl;
		...
		void testCase13(){
			std::cout << "ListTest testCase13 !!!" << std::endl;
		...
		void testCase14(){
			std::cout << "ListTest testCase14 !!!" << std::endl;

			stdL<int> l1(10, 0), l3(10, 1);
			msL<int> l2(10, 0), l4(10, 1);
		...
		void testCase15(){
			std::cout << "ListTest testCase15 !!!" << std::endl;

			msL<int> l1(10, 0), l2(10, 1), l3(10, 0);
